import type { PaginatedBoardGameInserts } from "@/features/collections/board-game-inserts/types/board-game-inserts";

export const boardGameInsertsProducts = {
  data: [
    {
...
} as const satisfies PaginatedBoardGameInserts;
